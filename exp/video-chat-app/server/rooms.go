...
// describes a single entitiy in the hashmap
type Participant struct {
	Host bool
	Conn *websocket.Conn
}

// is the main hashmap [roomID string] => [[]Participant]
type RoomMap struct {
	Mutex sync.RWMutex
...
func (r *RoomMap) CreateRoom() string {
	...
	var letters = []rune("qwertyuioplkjhgfdsazxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM123456789")
	b := make([]rune, 8)
...
// DeleteRoom deleted the room with the roomID
